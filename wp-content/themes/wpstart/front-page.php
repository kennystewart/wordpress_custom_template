...
<section class="welcome-area">
  <div class="welcome-pattern">
    <img src="<?php echo get_parent_theme_file_uri( '/assets/img/core-img/welcome-pattern.png' ); ?>" alt="" class="" />
  </div>
  <div class="welcome-slides owl-carousel">
    <div class="single-welcome-slide">
      ...
      <div class="welcome-thumbnail">
        <img src="<?php echo get_parent_theme_file_uri( '/assets/img/bg-img/1.png' ); ?>" alt="" class="" />
      </div>
    </div>
    <div class="single-welcome-slide">
      <div class="welcome-content h-100">
      ...
      <div class="welcome-thumbnail">
        <img src="<?php echo get_parent_theme_file_uri( '/assets/img/bg-img/2.png' ); ?>" alt="" class="" />
      </div>
    </div>
  </div>
  <div class="clouds">
    <img src="<?php echo get_parent_theme_file_uri( '/assets/img/core-img/cloud-1.png' ); ?>" alt="" class="cloud-1" />
    <img src="<?php echo get_parent_theme_file_uri( '/assets/img/core-img/cloud-2.png' ); ?>" alt="" class="cloud-2" />
    <img src="<?php echo get_parent_theme_file_uri( '/assets/img/core-img/cloud-3.png' ); ?>" alt="" class="cloud-3" />
    <img src="<?php echo get_parent_theme_file_uri( '/assets/img/core-img/cloud-4.png' ); ?>" alt="" class="cloud-4" />
    <img src="<?php echo get_parent_theme_file_uri( '/assets/img/core-img/cloud-5.png' ); ?>" alt="" class="cloud-5" />
  </div>
</section>
...
<section class="hami-support-area bg-gray">
  ...
  <div class="support-pattern" style="background-image: url(<?php echo get_parent_theme_file_uri( '/assets/img/core-img/support-pattern.png' ); ?>);">
  </div>
</section>
