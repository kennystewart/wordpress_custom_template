...
if ( ! class_exists( 'Islamic_Center_Mosque_WPTT_WebFont_Loader' ) ) {
	/**
	 * Download webfonts locally.
	 */
	class Islamic_Center_Mosque_WPTT_WebFont_Loader {
...
if ( ! function_exists( 'wptt_get_webfont_styles' ) ) {
	...
	function wptt_get_webfont_styles( $url, $format = 'woff2' ) {
		$font = new Islamic_Center_Mosque_WPTT_WebFont_Loader( $url );
